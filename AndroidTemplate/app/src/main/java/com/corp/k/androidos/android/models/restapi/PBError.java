...
public enum PBError {
    ...
    ERR_HTTP_UNKNOWN(-1, "HTTP Unknown Error"),
    ERR_HTTP_NO_NETWORKCONNECTION(-2, "No network connection"),
    ERR_HTTP_SERVER_RETURN_NULL(-3, "Server Rerturn NULL"),
    ERR_APP_INIT_ERR(-4, "Application initiazation encounted some error"),
    ERR_INVALID_DATA(-5, "Server Return Invalid Data"),
    ERR_HTTP_NO_INTERNET_CONNECTION(-6, "No Internet Connection");
    ...
    PBError(int value, String reasonPhrase) {
        this.value = value;
     ...
     */
    public static PBError valueOf(int statusCode) {
        for (PBError status : values()) {
    ...
    public enum Series {
        ...
        public static Series valueOf(PBError status) {
